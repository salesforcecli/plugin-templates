...
```
USAGE
  $ sf template generate project -n <value> [--json] [--flags-dir <value>] [-t standard|empty|analytics|reactinternalapp|reactexternalapp|agent] [-d
    <value>] [-s <value>] [-p <value>] [-x] [--lwc-language javascript|typescript] [--api-version <value>]
...
> > > > > > > 137253f (docs: add TypeScript project generation documentation)
